...
const employeeSeeds: EmployeeSeed[] = [
  {
    ...
    toolIds: ["calendar.schedule", "email.draft", "task.create", "task.progress", "delegate", "collab.ask"],
  ...
  },
  {
    ...
    provider: "local",
    temperature: 0.5,
    personality: { communicationStyle: "professional", decisionSpeed: "fast", autonomy: "high", reasoningDepth: "advanced" },
    toolIds: ["crm.update", "email.draft", "task.create", "task.progress", "delegate", "collab.ask"],
    permissions: ["employee:chat", "task:create", "task:assign", "knowledge:read"],
  ...
  },
  {
    ...
    provider: "local",
    temperature: 0.6,
    personality: { communicationStyle: "detailed", decisionSpeed: "balanced", autonomy: "high", reasoningDepth: "advanced" },
  ...
  },
  {
    ...
    provider: "local",
    temperature: 0.2,
    personality: { communicationStyle: "concise", decisionSpeed: "deliberate", autonomy: "low", reasoningDepth: "advanced" },
  ...
  },
  {
    ...
    toolIds: ["contract.review", "kb.search", "task.create", "task.progress", "collab.ask"],
    permissions: ["employee:chat", "task:create", "knowledge:read"],
  ...
  },
  {
    ...
    provider: "local",
    temperature: 0.4,
    personality: { communicationStyle: "detailed", decisionSpeed: "balanced", autonomy: "medium", reasoningDepth: "advanced" },
  ...
  },
  {
    ...
    provider: "local",
    temperature: 0.4,
    personality: { communicationStyle: "professional", decisionSpeed: "balanced", autonomy: "high", reasoningDepth: "standard" },
    toolIds: ["workflow.create", "analytics.query", "task.create", "task.progress"],
  ...
  },
  {
    ...
    provider: "local",
    temperature: 0.3,
    personality: { communicationStyle: "concise", decisionSpeed: "deliberate", autonomy: "medium", reasoningDepth: "standard" },
...
const tasks: Omit<Task, "id">[] = [
  { organizationId: ORG_ID, title: "Prepare board deck for Q3 review", description: "Compile metrics from Finance and Sales into the board template.", status: "in_progress", priority: "high", progress: 0.72, dueDate: new Date(Date.now() + 4 * 3600_000).toISOString(), assignee: { kind: "employee", id: "emp_exec_assistant" }, createdBy: { kind: "user", id: "usr_ceo" }, labels: ["board", "exec"], createdAt: TS, updatedAt: TS },
  { organizationId: ORG_ID, title: "Draft July social calendar", description: "Plan the posting cadence for launch month.", status: "in_progress", priority: "normal", progress: 0.4, assignee: { kind: "employee", id: "emp_social" }, createdBy: { kind: "employee", id: "emp_marketing_director" }, labels: ["marketing"], createdAt: TS, updatedAt: TS },
  { organizationId: ORG_ID, title: "Reconcile June invoices", description: "Month-end AR reconciliation.", status: "done", priority: "normal", assignee: { kind: "employee", id: "emp_accountant" }, createdBy: { kind: "user", id: "usr_ceo" }, labels: ["finance"], result: "All 214 invoices reconciled; two flagged for follow-up.", createdAt: TS, updatedAt: TS },
  { organizationId: ORG_ID, title: "Chase vendor quote for rack hardware", description: "Waiting on ServerCo's revised quote.", status: "blocked", priority: "normal", assignee: { kind: "employee", id: "emp_procurement" }, createdBy: { kind: "employee", id: "emp_ops_manager" }, labels: ["procurement"], createdAt: TS, updatedAt: TS },
