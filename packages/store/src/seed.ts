...
const tasks: Omit<Task, "id">[] = [
  { organizationId: ORG_ID, title: "Prepare board deck for Q3 review", description: "Compile metrics from Finance and Sales into the board template.", status: "in_progress", priority: "high", progress: 0.72, assignee: { kind: "employee", id: "emp_exec_assistant" }, createdBy: { kind: "user", id: "usr_ceo" }, labels: ["board", "exec"], createdAt: TS, updatedAt: TS },
