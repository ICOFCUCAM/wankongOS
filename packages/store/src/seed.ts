...
const employeeSeeds: EmployeeSeed[] = [
  {
    ...
    toolIds: ["calendar.schedule", "email.draft", "task.create", "task.progress", "delegate"],
  ...
  },
  {
    ...
    toolIds: ["crm.update", "email.draft", "task.create", "task.progress", "delegate"],
    permissions: ["employee:chat", "task:create", "task:assign", "knowledge:read"],
  ...
  },
  {
    ...
    toolIds: ["contract.review", "kb.search", "task.create", "task.progress"],
    permissions: ["employee:chat", "task:create", "knowledge:read"],
