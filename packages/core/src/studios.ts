...
export const STUDIOS: StudioDef[] = [
  ...
  { id: "presentation", name: "Presentation Engine", tagline: "Branded decks with executive summaries, charts, and speaker notes.", capabilities: ["deck", "executive_summary", "svg_charts", "speaker_notes"], formats: ["html", "markdown"], availability: "builtin", requiredPermission: "task:create" },
